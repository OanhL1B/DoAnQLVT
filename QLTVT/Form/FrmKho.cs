...
namespace QLTVT
{
    public partial class FormKho : Form
    {
        ...
        private void FormKho_Load(object sender, EventArgs e)
        {
            ...
            /*van con ton tai loi chua sua duoc*/ // lỗi gì k biết luôn ấy??
        ...
        private void cmbCHINHANH_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            /*Neu chon sang chi nhanh khac voi chi nhanh hien tai*/// thì sử dụng tài khoản HTKN
        ...
        private void btnGHI_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            /*declare @returnedResult int
              exec @returnedResult = sp_TimMaKho '20'
            ...
            int viTriMaKhoHang = bdsKho.Find("MAKHO", txtMAKHO.Text); // vị trí đang sử hay thêm gì đó
            ...
            else
            {
                ...
                if (dr == DialogResult.OK)
                {
                    try
                    {
                        ...
                        /*trước khi ấn btnGHI là btnTHEM*/// là thêm thì xóa
                        if (dangThemMoi == true)
                        {
                            cauTruyVanHoanTac = "" +
                                "DELETE DBO.KHO " +
                        ...
                        /*trước khi ấn btnGHI là sửa thông tin kho*/ // à insert thì uptade
                        else
                        {
                            cauTruyVanHoanTac =
                                "UPDATE DBO.KHO " +
