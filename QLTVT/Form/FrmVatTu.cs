...
namespace QLTVT
{
    public partial class FormVatTu : Form
    {
         ...
         **********************************************************/
        Stack undoList = new Stack(); // này hiểu rồi nè
        ...
        {
            this.Validate(); // kiểu tra phù hợp dữ liệu


        }
        // này giống với bên nhân viên đọc nhanh 
        ...
        // chỗ dưới này chưa hiểu dùng để làm gì
         ...
         * 
         * bdsNhanVien.CancelEdit() - phục hồi lại dữ liệu nếu chưa ấn  btnGHI
        ...
        private void btnHOANTAC_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (dangThemMoi == true && this.btnTHEM.Enabled == false)
            {
                ...
                bdsVatTu.CancelEdit(); // khôi phục lai dữ liệu nếu chưa ấn btnGhi
                /*xoa dong hien tai*/
         ...
         * viTriMaVatTu: vi tri cua ma vật tư voi btnTHEM or hanh dong sua du lieu
         * sp_TimMavattu tra ve 0 neu khong ton tai
         *                          1 neu ton tai
         *                                    
         * Step 0 : Kiem tra du lieu dau vao
         * Step 1 : Dung stored procedure sp_TimMavattu de kiem tra txtMAVT
         * Step 2 : Ket hop ket qua tu Step 1 & vi tri cua txtMAVT co 2 truong hop xay ra
         * + TH0: ketQua = 1 && viTriConTro != viTriMaVatTu -> thêm mới nhưng mã vật tư đã tồn tại rồi
         * + TH1: ketQua = 1 && viTriConTro == viTriMaVatTu -> sửa vật tư cũ
         * + TH2: ketQua = 0 && viTriConTro == viTriMaVatTu -> có thể thêm mới vật tư
         * + TH3: ketQua = 0 && viTriConTro != viTriMaVatTu -> có thể thêm mới vật tư
         *         
        ...
        private void btnGHI_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //kết quả trả về của result là 0 or 1
            ...
            else
            {
                ...
                if (dr == DialogResult.OK)
                {
                    try
                    {
                        ...
                        /*trước khi ấn btnGHI là sửa thông tin vật tư*/
                        else
                        {
                            cauTruyVanHoanTac =
                                "UPDATE DBO.VATTU " +
        ...
        private void btnLAMMOI_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                // do du lieu moi tu dataSet vao gridControl VATTU
                this.vattuTableAdapter.Fill(this.dataSet.Vattu);
                this.gcVATTU.Enabled = true;
            }
            catch (Exception ex)
        ...
        {
            /*Step 1*/
            // kiểm tra k có vật tư thì không xóa được
            if (bdsVatTu.Count == 0)
            {
